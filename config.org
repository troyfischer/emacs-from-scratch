...
;;   (ivy-mode)
;;   (setq ivy-initial-inputs-alist nil)
;;   (general-evil-define-key '(normal insert) ivy-minibuffer-map (kbd "C-j") 'ivy-next-line)
;;   (general-evil-define-key '(normal insert) ivy-minibuffer-map (kbd "C-k") 'ivy-previous-line)
;;   (general-evil-define-key '(normal insert) ivy-minibuffer-map (kbd "C-l") 'ivy-alt-done)
;;   (general-evil-define-key '(normal insert) ivy-minibuffer-map (kbd "C-h") 'delete-backward-char))
